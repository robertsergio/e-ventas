...
INSERT INTO `ci_sessions` (`session_id`, `ip_address`, `user_agent`, `last_activity`, `user_data`) VALUES ('26d532409cc6b163872876cb7cab3da8', '127.0.0.1', 'Mozilla/5.0 (Windows; U; Windows NT 5.1; es-ES; rv', 1242233075, '');
COMMIT;
...
INSERT INTO `clientes` (`id`, `nombre`, `apellido`, `telefono`, `direccion`, `email`, `ruc`, `barrio_id`, `borrado`, `celular`, `vendedor_id`, `ci`) VALUES (6, 'Un Cliente', 'de Prueba', '55555', 'Concepcion 3252 e/ Paraiso y Guarayos.', 'lindo@loco.com', '2288512', 1, 0, '666666', 10, '2288512');
INSERT INTO `clientes` (`id`, `nombre`, `apellido`, `telefono`, `direccion`, `email`, `ruc`, `barrio_id`, `borrado`, `celular`, `vendedor_id`, `ci`) VALUES (7, 'Ña Eustaquia', 'Doe', '34234', 'Concepcion 3252 c/ Paraiso.', 'juan@perez.com', '23423423-0', 1, 0, '2342342', 16, '3232323');
COMMIT;
